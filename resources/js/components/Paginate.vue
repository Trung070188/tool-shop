<template>
  <ul class="pagination">
    <li class="page-item" :class="{'disabled': value.currentPage === 1}" @click="changePage(1)"><a href="javascript:;" class="page-link">‹‹</a></li>
    <li class="page-item"  :class="{'disabled': value.currentPage === 1}" @click="prevPage()"><a href="javascript:;" class="page-link">‹</a></li>
    <li v-for="page in getPages()" @click="changePage(page.key)" :class="page.class"><a class="page-link"
                                                                                        href="javascript:;"
                                                                                        v-text="page.key"></a></li>
    <li class="page-item" :class="{'disabled': value.currentPage === value.lastPage}" @click="nextPage()"><a class="page-link" href="javascript:;">›</a></li>
    <li class="page-item" :class="{'disabled': value.currentPage === value.lastPage}" @click="changePage(value.lastPage)"><a class="page-link" href="javascript:;">››</a></li>
  </ul>
</template>
